...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT p.*, pi.product_quantity FROM product AS p INNER JOIN productinventory AS pi ON p.product_id = pi.product_id WHERE p.product_id = $product_id";
    ...
    if ($result->num_rows > 0) {
        ...
        } elseif ($row['product_quantity'] > 0 && $row['product_quantity'] <= 5) {
            $stockStatus = 'Few pieces left - Order fast';
        }
        ...
        ?>
                <div class="product-details">
                    ...
                    <div class="info">
                        ...
                        <p style="<?php echo $stockStatusStyle; ?>"><?php echo $stockStatus; ?></p>
                        <button class="add-to-cart <?php echo $disableButton ? 'disabled' : ''; ?>" onclick="addToCart(<?php echo $_GET['id']; ?>)" <?php echo $disableButton; ?>>Add to Cart</button>
