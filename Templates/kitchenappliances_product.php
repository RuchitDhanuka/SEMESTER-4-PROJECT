...
<header class="gradient-bg">
  ...
  <br>
  <h1 class="section-heading">Kitchen Appliances</h1>
  ...
  <div class="container">
    ...
    $sql = "SELECT p.*, pi.product_quantity FROM product AS p INNER JOIN productinventory AS pi ON p.product_id = pi.product_id WHERE p.category_id=2 $sortSql";
